...
void loadImages(void) {
	...
	fn[0] = "dino0.txt"; fn[1] = "dino1.txt"; fn[2] = "dino2.txt";
	...
	for(int i = 0; i < 4; i++) {
		...
		if(fp == NULL) {
			...
			switch(i) {
				case 0:	fig.dino0 = temp; break;
				case 1:	fig.dino1 = temp; break;
				case 2:	fig.dino2 = temp; break;
				case 3: scn.cacti = temp; break;
			}
		}
	}
}
...
void loop(int val) {
	...
	if(halt == false)	glutPostRedisplay();
...
void updateCacti(void) {
	if(cactusPos[4] == winRightEdge)	lastPushed = runtime;
...
void drawFigure(int f, int xpos, int ypos, int yoff, int bsize) {
	...
	switch(f) {
		case 0:	ar = fig.dino0; break;
		case 1:	ar = fig.dino1; break;
		case 2:	ar = fig.dino2; break;
		case 3: ar = scn.cacti; break;
	}
